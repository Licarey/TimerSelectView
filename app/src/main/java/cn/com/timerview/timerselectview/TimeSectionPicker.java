...
public class TimeSectionPicker extends View implements View.OnTouchListener {
    ...
    private int textSize = Util.dp2px(App.getmInstance(),12);
    ...
    private float extendPointR = Util.dp2px(App.getmInstance(),8);//拉伸点半径
    private int space = Util.dp2px(App.getmInstance(),25);//刻度间隔
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isFrist) {//初始化参数
            ...
            Log.e("","titles.length:" + titles.length);
